  ...
  return (
    <header>
      <div className="relative font-medium">
        ...
        <div
          className={clsx(
            'transition ease-in-out inset-x-0 dark:bg-gray-900 z-40 w-full bg-white border-b dark:border-gray-600 border-gray-300',
            isScrolled ? 'fixed top-0 shadow-xl' : 'relative'
          )}
        >
          <div className="dark:border-gray-600 w-full border-b border-gray-300">
            <div className="container flex items-center p-4 mx-auto text-sm">
              <Link href="/">
          ...
          <div className="container flex items-center justify-between px-4 mx-auto text-xs">
