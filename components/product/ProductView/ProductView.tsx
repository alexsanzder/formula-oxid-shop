  ...
  useScrollPosition(
    ({ currPos }) => {
      ...
      if (detailsRef.current) {
        detailsRef.current.getBoundingClientRect().top <= 52 && setActive(0);
      }
      if (reviewsRef.current) {
        reviewsRef.current.getBoundingClientRect().top <= 52 && setActive(1);
      }
      if (accessoriesRef.current) {
        accessoriesRef.current.getBoundingClientRect().top <= 52 && setActive(2);
      }
      if (relatedRef.current) {
        relatedRef.current.getBoundingClientRect().top <= 52 && setActive(3);
      }
    },
    [isSticky, isShadowed],
    undefined,
    ...
    <>
          ...
          <div className="flex overflow-x-scroll text-sm text-gray-900">
            ...
            <button
              className={clsx(
                ...
                'dark:text-gray-200 dark:bg-transparent ',
                'hover:border-gray-900 dark:hover:border-gray-50',
                active === 1 && 'border-gray-900 dark:border-gray-50'
              )}
            >
              Reviews
            </button>
            {product.accessories.length ? (
              <button
                className={clsx(
                  ...
                  'dark:text-gray-200 dark:bg-transparent ',
                  'hover:border-gray-900 dark:hover:border-gray-50',
                  active === 2 && 'border-gray-900 dark:border-gray-50'
                )}
              >
                Accessories
              </button>
            ...
            <button
              className={clsx(
                ...
                'dark:text-gray-200 dark:bg-transparent ',
                'hover:border-gray-900 dark:hover:border-gray-50',
                active === 3 && 'border-gray-900 dark:border-gray-50'
              )}
            >
              Related
            </button>
      ...
      <article className="container flex-col items-start pt-4 pb-8 mx-auto space-y-4">
          ...
          <aside>
            <div className="w-96 flex flex-col px-6">
              ...
              <div className="dark:border-gray-600 py-2 border-b border-gray-200">
                <h2
                  className="pb-1 text-2xl font-bold"
                  dangerouslySetInnerHTML={{
                    __html: product.title,
                  }}
                />
                <StarRating count={product.rating.rating} />
                <p
        ...
        <div className="flex flex-col space-y-4">
          <div ref={reviewsRef} className="container w-full py-8 mx-auto">
          ...
          {product.accessories.length ? (
            <div ref={accessoriesRef} className="container w-full py-8 mx-auto">
          ...
          {product.crossSelling ? (
            <div ref={relatedRef} className="container w-full py-8 mx-auto">
